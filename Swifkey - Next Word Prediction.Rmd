...
#### We will explore the data by looking at 

1. Top Words - Visualise using wordcloud and ggplot function to view the top words.
2. Coverage - How many unique words needed in a frequency sorted dictionary to cover 50% of all word instances in the language? 90%?
...
#### The top 100 words from the blogs, news and Twitter combined into a single corpus:
```{r rawDataCorpus}
