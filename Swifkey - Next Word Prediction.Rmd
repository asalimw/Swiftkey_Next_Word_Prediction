...
After tokinising and performing some text analysis, the corpus contains `r total.Features` features and this is the top 20 most frequent words:
`r kable(top20.Features)`.
